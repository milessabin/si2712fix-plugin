...
public class TypeVarSub extends Types.TypeVar$ {
  ...
  public Types.TypeVar apply(Types.Type origin, TypeConstraints.TypeConstraint constr) {
    return delegate.apply(origin, constr, (List<Types.Type>)(Object)Nil$.MODULE$, (List<Symbols.Symbol>)(Object)Nil$.MODULE$);
  }

  public Types.TypeVar apply(Types.Type origin, TypeConstraints.TypeConstraint constr, List<Types.Type> args, List<Symbols.Symbol> params) {
